        ...
        <div class="container">
            <main class="form-register">
                <form action="{{route('register')}}" method="POST">
                    ...
                    <div class="form-floating">
                        <input type="char" name="phone" class="form-control mt-2" id="phone" placeholder="081314832436">
                        <label for="phone">Number Phone</label>
                    </div>
                    <div class="form-floating">
                        <input type="addres" name="address" class="form-control mt-2" id="addres" placeholder="addres">
